...
class LocalChatGatewayTests(unittest.TestCase):
    ...
    def test_ui_has_no_external_assets(self) -> None:
        ...
        self.assertIn("Естественный режим с проверкой Home Assistant", gateway.HTML)
        self.assertIn("const routedMessage=message", gateway.HTML)
        self.assertNotIn("'/модель '+message", gateway.HTML)
